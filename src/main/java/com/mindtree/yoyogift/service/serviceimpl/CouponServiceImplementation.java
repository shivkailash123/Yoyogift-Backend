...
public class CouponServiceImplementation implements CouponReedemService {
	...
	public String couponReedem(GiftCardDto giftCardDto) throws ServiceException {
		...
		/*
		 * Checking Balance is sufficient in the wallet
		 */
		...
		/*
		 * Checking Sufficient Quantity is present in the backend
		 */
	...
	/*
	 * Generating coupouncode and returning into the function
	 */
